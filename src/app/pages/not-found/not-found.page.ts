...
export class NotFoundPage implements OnInit {
  ...
  error_message = "We are experiencing \
  ...
  constructor(public route: ActivatedRoute, public title: Title) {
    ...
    if (this.error_code == 404) {
      ...
      this.error_message = "Our apologies. The page you're looking for \
      ...
      this.error_message = "Opps. You don't have enough privilages to access \
      ...
      this.error_message = "Opps. Bad request reached on our side, please make \
                          sure you used proper instructions."; }

    this.title.setTitle("Hetchfund.Capital | " + this.error_title)
  }
